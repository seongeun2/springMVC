...
public class MemberController {
	...
	public String memberOrders(@PathVariable("memberId")
	...
	public String memberOrderDetail(@PathVariable("memberId") String memberId, @PathVariable("orderId")
			Long orderId, Model model) {
